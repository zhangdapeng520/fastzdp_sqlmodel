...
engine = fasm.get_engine(password="zhangdapeng520", database="fastzdp_sqlmodel", echo=False)
...
c1 = {
    "name": "FastAPI零基础入门",
    "class_id": 2,
    "class_name": "FastAPI+Vue3 全栈班",
    "order": 1,
    "price": 248,
    "add_time": int(time.time())
}
fasm.add(engine, Course(**c1))

fasm.update_id(engine, Course, 1, {"name": "xxx"})

data = fasm.get_all(engine, Course)
print(data)

fasm.delete_id(engine, Course, 1)
